(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".swiper", {
            ...
            navigation: {
                prevEl: ".comment__prevSlide",
                nextEl: ".comment__nextSlide"
            },
            breakpoints: {
                855: {
                    slidesPerView: 2,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        let popup2 = document.getElementById("popupVid2");
        let popup1 = document.getElementById("popupVid1");
        let popup3 = document.getElementById("popupVid3");
        let link2 = document.getElementById("working8");
        let link1 = document.getElementById("working7");
        let link3 = document.getElementById("working9");
